...
(provenance); **26 new `@streetjs/*` packages published at 1.0.0 with SLSA provenance**
(8 foundation + 18 extracted core modules); **core-monolith split underway** via
...
**Extracted core modules (18) — dependency inversion, core re-exports each:**
...
**Split mechanics (reusable, proven across all 18 extractions):** core's `prebuild`/
