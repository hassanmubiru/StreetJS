...
(provenance); **25 new `@streetjs/*` packages published at 1.0.0 with SLSA provenance**
(8 foundation + 17 extracted core modules); **core-monolith split underway** via
...
**Split mechanics (reusable, proven across all 16 extractions):** core's `prebuild`/
