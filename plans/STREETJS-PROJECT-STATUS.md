...
(provenance); **29 new `@streetjs/*` packages published (1.0.0, `context` at 1.1.0) with SLSA provenance**
(8 foundation + 21 extracted core modules); **core-monolith split underway** via
...
**Extracted core modules (20) — dependency inversion, core re-exports each:**
