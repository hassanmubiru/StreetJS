...
(provenance); **24 new `@streetjs/*` packages published at 1.0.0 with SLSA provenance**
(8 foundation + 16 extracted core modules); **core-monolith split underway** via
...
**Extracted core modules (16) — dependency inversion, core re-exports each:**
...
**Split mechanics (reusable, proven across all 15 extractions):** core's `prebuild`/
