...
(provenance); **23 new `@streetjs/*` packages published at 1.0.0 with SLSA provenance**
(8 foundation + 15 extracted core modules); **core-monolith split underway** via
...
**Extracted core modules (15) — dependency inversion, core re-exports each:**
...
**Split mechanics (reusable, proven across all 14 extractions):** core's `prebuild`/
