...
(provenance); **28 new `@streetjs/*` packages published (1.0.0, `context` at 1.1.0) with SLSA provenance**
(8 foundation + 20 extracted core modules); **core-monolith split underway** via
...
**Extracted core modules (19) — dependency inversion, core re-exports each:**
...
**Split mechanics (reusable, proven across all 19 extractions):** core's `prebuild`/
